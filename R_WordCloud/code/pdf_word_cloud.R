...
##
i_workingPath <- "D:/Git_Projects/R/R_WordCloud/code/data"
i_pdfPath <- "documents"

i_dataExport <- "D:/Git_Projects/R/R_WordCloud/results/wordclouds/"
i_dataExportTags <- "D:/Git_Projects/R/R_WordCloud/results/tags/"
